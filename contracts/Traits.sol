...
contract Traits is Ownable {
    ...
    function drawSVG(uint256 tokenId) public view returns (string memory) {
        IRichcityNFT.RichCity memory s = game.getTokenTraits(tokenId);
        uint8 shift = s.isGangster ? s.level <= 3 ? 0 : 20 : 10;
        string memory svgString;
        if (s.isGangster && s.level <= 3) {
            svgString = string(
                abi.encodePacked(
                    drawTrait(
                        traitData[5 + shift][
        ...
        } else if (s.isGangster && s.level > 3) {
            svgString = string(
                abi.encodePacked(
                    drawTrait(
                        traitData[5 + shift][
        ...
        if (s.isGangster && s.level <= 3) {
            traits = string(
                abi.encodePacked(
                    attributeForTypeAndValue(
                        _traitTypes[0],
                        traitData[6][s.clothes % traitCountForType[6]].name
                    ),
                    ",",
                    attributeForTypeAndValue(
                        _traitTypes[1],
                        traitData[8][s.hair % traitCountForType[8]].name
                    ),
                    ",",
                    attributeForTypeAndValue(
                        _traitTypes[2],
                        traitData[9][s.jewelry % traitCountForType[9]].name
                    ),
                    ",",
                    attributeForTypeAndValue(
                        _traitTypes[3],
                        traitData[9][s.tatto % traitCountForType[9]].name
                    ),
                    ",",
                    attributeForTypeAndValue(
                        _traitTypes[9],
                    ...
                    ",",
                    attributeForTypeAndValue("Level", _level[s.level - 1]),
                    ","
                )
            );
        } else if (s.isGangster && s.level > 3) {
            traits = string(
                abi.encodePacked(
                    attributeForTypeAndValue(
                        _traitTypes[4],
                        traitData[29][s.belt % traitCountForType[29]].name
                    ),
                    ",",
                    attributeForTypeAndValue(
                        _traitTypes[1],
                        traitData[28][s.hair % traitCountForType[28]].name
                    ),
                    ",",
                    attributeForTypeAndValue(
                        _traitTypes[5],
                        traitData[30][s.sunglass % traitCountForType[30]].name
                    ),
                    ",",
                    attributeForTypeAndValue(
                        _traitTypes[9],
            ...
            traits = string(
                abi.encodePacked(
                    attributeForTypeAndValue(
                        _traitTypes[0],
                        traitData[16][s.clothes % traitCountForType[16]].name
                    ),
                    ",",
                    attributeForTypeAndValue(
                        _traitTypes[7],
                        traitData[18][s.mask % traitCountForType[18]].name
                    ),
                    ",",
                    attributeForTypeAndValue(
                        _traitTypes[8],
                        traitData[19][s.weapon % traitCountForType[19]].name
                    ),
                    ",",
                    attributeForTypeAndValue(
                        _traitTypes[6],
                        traitData[20][s.hat % traitCountForType[20]].name
                    ),
                    ",",
                    attributeForTypeAndValue(
                        _traitTypes[9],
    ...
    function tokenURI(uint256 tokenId) public view returns (string memory) {
        ...
        string memory metadata = string(
            abi.encodePacked(
                '{"name": "',
                s.isGangster
                    ? s.level <= 3 ? "Gangster #" : "Gangster LEAD #"
                    : "SWAT #",
                tokenId.toString(),
